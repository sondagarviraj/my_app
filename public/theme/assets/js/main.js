(function ($) {
    ...
    //Buy Now Button
    $('body').append("<a href='https://themeforest.net/item/ekom-single-product-ecommerce-html-template/35968252?s_rank=2' class='buy-now-btn' target='_blank'><img src='assets/img/envato.png' alt='envato'/>Buy Now</a>"); 
    ...
    $(".product-slider-three").owlCarousel({
        nav: false,
        dots: true,
        loop: true,
        margin: 22,
    ...
    var swiper_thumbs_2 = new Swiper(".single-product_thumbs", {
        spaceBetween: 20,
        slidesPerView: 3,
        freeMode: true,
        watchSlidesVisibility: true,
    ...
    var swiper3 = new Swiper(".single-product_slider", {
        spaceBetween: 10,
        loop: true,
        autoplay:false,
        navigation: {
        ...
        thumbs: {
            swiper: swiper_thumbs_2,
        },
    });

    //Magnific Popup Video
    $('.play-now, .play-video').magnificPopup({
        type: 'iframe',
        mainClass: 'mfp-fade',
        preloader: true,
    });
